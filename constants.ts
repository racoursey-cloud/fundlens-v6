...
export const RSS_FEEDS = [
  {
    ...
    purpose: 'Global wire service. First to report market-moving events.',
  },
  {
    name: 'CNBC Economy',
  ...
  {
    name: 'AP News',
    url: 'https://rss.app/feeds/v1.1/tPnKMq0fOPcLOhgA.xml',
    purpose: 'Breaking non-financial events that move markets.',
  },
  {
